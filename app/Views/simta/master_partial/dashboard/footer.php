        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="recipient-name" class="col-form-label">Upload File Excel Data Mata Kuliah</label>
                </div>
                <form action="<?= base_url('mata-kuliah/import')?>" method="POST" enctype="multipart/form-data"
                    ...
                    <input type="file" name="file_excel" id="file_excel" class="d-none" accept=".xlsx,.xls">
                </form>
                <!-- Preview -->
