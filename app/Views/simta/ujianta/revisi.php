    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                <div class="row">
                    <div class="col-sm-6">
                        <h2 class="mt-2 page-title">Halaman Revisi Proposal Ujian Tugas Akhir</h2>
                    </div>
                <?php if(has_permission('admin') || has_permission('dosen')): ?>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right mb-0">
                            ...
                            <li class="breadcrumb-item active">Revisi Proposal Ujian Tugas Akhir</li>
                        </ol>
                    </div>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <form method="POST" enctype="multipart/form-data"
                                    action="<?=base_url("simta/ujianta/updaterevisi/" . $ujianta->id_ujianta)?>">
                                    <?=csrf_field(); ?>
